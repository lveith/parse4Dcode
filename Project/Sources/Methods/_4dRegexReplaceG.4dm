...
// PM: "_4dRegexReplaceG" (neu LV 21.05.20, 09:57:00)
...
// _4dRegexReplaceG (srcTxt;regexPattern{;replaceWithText{;startPos{;maxLength}}}) -> resultTxt
...
// UseExamples:
// - $resultTxt:=_4dRegexReplaceG ("abc123xy98";"\\d")  // -> "abcxy"
// - $resultTxt:=_4dRegexReplaceG ("abc123xy98";"\\D")  // -> "12398"
// - $resultTxt:=_4dRegexReplaceG ("1a2bc123xy98";"\\D";"z")  // -> "1z2zz123zz98"
// - $resultTxt:=_4dRegexReplaceG ("abc123 \r\n\t xy98";"\\p{C}")  // -> "abc123  xy98" // replaces all cntrl-codes (not only CR, LF or TAB)
// - $resultTxt:=_4dRegexReplaceG ("abc123 \r\n\t xy98";"[:cntrl:]")  // -> "abc123  xy98" // replaces all cntrl-codes (not only CR, LF or TAB)
// - $resultTxt:=_4dRegexReplaceG ("ABCSS123abcß98";"(?i:abcss)")  // -> "12398"
// - $resultTxt:=_4dRegexReplaceG ("ABC123abc98";"(?-i:abc)")  // -> "ABC12398"
// - $resultTxt:=_4dRegexReplaceG ("aBxy123aBxY";"(?i)abxy")  // -> "123"
// - $resultTxt:=_4dRegexReplaceG ("aBxy123aBxY";"(?i:ab)(?-i:xy)")  // -> "123aBxY"
